...
sudo sed -i s/"local   all             postgres                                peer"/"local    all             postgres                                trust"/g /etc/postgresql/9.5/main/pg_hba.conf
...
sudo sed -i s/"local    all             postgres                                trust"/"local   all             postgres                                md5 "/g /etc/postgresql/9.5/main/pg_hba.conf
sudo sed -i s/"local   all             all                                     peer"/"local   all             $ODOO_USER                                    md5"/g /etc/postgresql/9.5/main/pg_hba.conf
sudo /etc/init.d/postgresql restart
#--------------------------------------------------
